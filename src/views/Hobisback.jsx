...
function Hobisback() {
  ...
  return (
    <>
      <div
        className={`min-h-screen flex justify-center items-center bg-bghobiDesktop1 bg-cover bg-center bg-no-repeat max-sm:bg-center max-sm:bg-bghobidischargep ${
          cargando
      ...
      >
        <div
          className={`flex flex-col justify-center max-sm:px-2 ${
