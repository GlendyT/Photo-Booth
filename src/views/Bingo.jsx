...
export default function Bingo() {
  ...
  return (
    <>
      <div className="min-h-screen pt-4 max-sm:pb-10 bg-nav bg-center bg-no-repeat bg-cover ">
        <div className="mx-96 max-sm:mx-0 max-sm:px-0 max-lg:mx-20 max-xl:mx-44 border-2 border-gray-200  bg-purple-400" id="print">
