        ...
        <div className="w-auto my-2 mx-auto max-w-3xl max-sm:max-w-2xl">
          <div className="shadow-lg flex flex-col w-full outline-none focus:outline-none uppercase">
            <div id="print" className="relative ">
              <img src={card} alt="virthdaytae" className="w-auto h-96" />
              <div className="absolute inset-0 flex flex-col justify-end items-center pb-[10rem] pr-36">
                <div className=" w-full flex flex-col items-center px-4 py-2 rounded-md font-extrabold font-virthday3 text-xs max-sm:text-xs max-md:text-xs max-lg:text-xs max-2xl:text-xs text-white tracking-wide ">
